...
2. Safety and Disclaimer
   Since the App uses Bluetooth for communication with microcontrollers and similar devices, delays may occur or unexpected behavior may result depending on the communication environment. Please refrain from operating devices that may pose a risk to people or property due to malfunctions, errors in the App, or user mishandling. The Provider assumes no responsibility for any damages caused by malfunctions or errors in the App. 
