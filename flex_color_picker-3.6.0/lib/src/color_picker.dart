...
class _ColorPickerState extends State<ColorPicker> {
  ...
  void initState() {
    ...
    // Initialize controllers with default color values
    _updateTextFields(_selectedColor);
  }
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              contentPadding: const EdgeInsets.symmetric(vertical: 10), // Adjust content padding
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: Theme.of(context).brightness == Brightness.dark ? Colors.white24 : Colors.black12),
                    ),
                    child: Column(
